...
console.log('Por ser su primera compra recibirá el siguiente descuento individual por cada VDF comprado: ');
...
consolee.log(`disponibilidad: ${isAvailable}`);
...
console.log("typeof isAviable:    ", typeof isAvailable);
console.log("");
...
console.log("Nuevo reabastecimiento:", pendingValue);
